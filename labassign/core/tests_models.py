...
class ModelTests(TestCase):
    ...
    def test_models(self):
        ...
        self.iterate(Teacher, "teacher.pkl", ["first_name", "last_name"])
        ...
        self.iterate(TheoryGroup, "theorygroup.pkl", ["groupName", "language"])
        print("Testing GroupConstraints:")
        self.iterate(
            GroupConstraints,
            "groupconstraints.pkl",
        ...
        print("Testing Pair:")
        self.iterate(Pair, "pair.pkl", ["student1", "student2", "validated"])
        print("Testing OtherConstraints:")
        self.iterate(
            OtherConstraints,
            "otherconstraints.pkl",
